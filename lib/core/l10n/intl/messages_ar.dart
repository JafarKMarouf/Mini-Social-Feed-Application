...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(statusCode) => "خطأ في الطلب (${statusCode}).";

  static String m1(statusCode) => "خطأ في الخادم (${statusCode}).";

  static String m2(statusCode) => "خطأ غير معروف (${statusCode} أو بدون رمز).";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "intro2": MessageLookupByLibrary.simpleMessage(
      "قم بإنشاء منشورات جديدة وتحديث المنشورات الحالية وإدارة المحتوى الخاص بك بسهولة. حمّل الصور ومقاطع الفيديو مباشرة من جهازك باستخدام مرفقات الوسائط البسيطة.",
    ),
