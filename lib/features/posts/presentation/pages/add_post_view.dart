...
import 'package:mini_social_feed/features/posts/presentation/widgets/add_post_widgets/create_post_app_bar.dart';
      ...
      child: SafeArea(
        child: Stack(
          children: [
            CustomScrollView(
              slivers: [
                CreatePostAppBar(publishPost: () => _onPublishPressed(context)),
                SliverToBoxAdapter(
                  child: Padding(
                        ...
                        return Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (_selectedFiles.isNotEmpty) ...[
                                DisplayMediaGrid(selectedFiles: _selectedFiles),
                                const SizedBox(height: 20),
                              ],
                              MediaToolBar(
